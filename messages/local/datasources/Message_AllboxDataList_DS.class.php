...
/**
 * This is Message_AllboxDataList_DS.php
 *
 * This does .......
 *
...
* @package messages
*/
class Message_AllboxDataList_DS extends Datasource_sql 
{
	/**
	 ...
	 * @var string
	 */
	var $_internalName = 'Message_AllboxDataList_DS';
	...
	*
 	...
 	* @return void
        */
	function Message_AllboxDataList_DS($external_id) {

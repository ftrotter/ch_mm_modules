...
/**
 * This is eMessage_SentDataList_Ds.class.php
 *
 * This does .......
 *
...
* @package messages
*/
class Message_SentDataList_DS extends Datasource_sql 
{
	/**
	 ...
	 * @var string
	 */
	var $_internalName = 'Message_SentDataList_DS';
	...
	*
 	...
 	* @return void 
        */
	function Message_SentDataList_DS($external_id) {
...
$labels = array(
                        //      'message_number' => 'total messages',
                        //      'read_number' => 'total read',
                        //      'to_person'=>'To',
                        //      'to_first'=>'To First',
                        //      'to_last'=>'To Last',
                        //      'subject'=>'Subject',
		...
		$this->setup(Celini::dbInstance(),
			array(
				...
				'where'   => "from_person = $external_id $task_logic "
			),
			$labels					
			);
